...
const Navbar = () => {
    ...
    <div className='lg:flex hidden items-center justify-center gap-2'>
        <div className='flex items-center gap-2 backdrop-blur-xl bg-white/[0.08] border 
          border-white/[0.12] rounded-full p-2 saturate-150'>
            {tabs.map((t)=>(
                <Link 
                key={t.href}
                href={t.href}
                className={[
                    ...
                    ? 'bg-white/[0.12] text-white font-medium border border-white/[0.16] backdrop-blur-sm'
       ...
       <div className='flex items-center gap-4 justify-end'>
        ...
        <Button 
          variant="secondary"
          className='rounded-full h-12 w-12 fle x items-center justify-center backdrop-blur-xl bg-white/[0.08] 
          border border-white/[0.012] saturate-150 hover:bg-white/[0.12]'
