...
from-primary to-primary/60 rounded-full mb-4 shadow-lg">
        ...
        <Card className='backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] shadow-xl saturate-150' >
          <CardHeader className='text-center pb-4'>
            <div>
              <Badge className='bg-primary/20 text-primary border-primary/30 px-3 py-1 text-xs font-medium rounded-full'>Most Popular</Badge>

            </div>
            <CardTitle className='ttext-2xl font-bold text-foreground mb-2'>Standard Plan</CardTitle>
            <div className='flex items-baseline justify-center space-x-2'>
              <span className='text-4xl font-bold text-foreground'>$9.99</span>
              <span className='text-muted-foreground text-base'>/month</span>
            </div>
            <CardDescription className='text-muted-foreground text-sm mt-2'>
              Get 10 credits every month to power your AI-assisted design projects.
          ...
          <CardContent className='space-y-4 px-6'>
            ...
            <div className='space-y-3'>
              ...
              <div className='grid gap-2'>
                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/[0.05] border
              border-white/[0.08]">
